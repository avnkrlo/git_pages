...
<template>
    <footer class="bg-white dark:bg-gray-900">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
                ...
                <div class="grid grid-cols-3 mx-auto mb-6 md:mb-0">
                    ...
                    <div>
                        <a>
                            <h2>67 Al Hattan St. Abu Dhabi Emirate, UAE</h2>
                        </a>
                    </div>
                </div>

                <div class="grid grid-cols-2 gap-10 sm:gap-6 sm:grid-cols-2">
                    <div>
        ...
        <hr class="my-8 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
